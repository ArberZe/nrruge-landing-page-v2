    ...
    >
      ...
      >
        ...
        <motion.div
          ...
          className="mb-12"
        >
          <h1 className="text-5xl md:text-6xl bg-gradient-to-r from-white via-blue-100 to-white bg-clip-text text-transparent tracking-tight mb-2">
            nrruge
          </h1>
        </motion.div>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <div className="flex-1 relative group">
              <input
                ...
                required
                className="w-full px-6 py-4 bg-white/5 backdrop-blur-xl border border-blue-500/30 rounded-2xl text-white placeholder:text-gray-500 focus:outline-none focus:border-blue-400 focus:ring-4 focus:ring-blue-500/20 transition-all duration-300"
                style={{
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="px-8 py-4 bg-gradient-to-r from-blue-600 to-blue-500 text-white rounded-2xl shadow-lg shadow-blue-500/50 hover:shadow-blue-500/70 transition-all duration-300 relative overflow-hidden group"
            >
        ...
        >
          <div className="relative">
            {/* Glassmorphic frame around image */}
            ...
            <div className="relative bg-white/5 backdrop-blur-xl border border-blue-500/30 rounded-3xl p-2 shadow-2xl shadow-blue-500/20">
              <ImageWithFallback
                src="https://images.unsplash.com/photo-1750056393356-d1de9d222a29?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb2Rlcm4lMjBzbWFydHBob25lJTIwYXBwJTIwbW9ja3VwfGVufDF8fHx8MTc2NzQ0MTU3OXww&ixlib=rb-4.1.0&q=80&w=1080"
